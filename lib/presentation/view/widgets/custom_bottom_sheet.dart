      ...
      children: [
        ...
        Flexible(
          child: Container(
            ...
            child: Padding(
              padding: const EdgeInsets.only(left: 26.0, right: 26, top: 25),
              child: Column(
                ...
                children: [
                  ...
                  if (selectedItem == null)
                    Container(
                      width: context.screenWidth,
                      height: 1,
                      color: CustomColors.textFieldHintColor.withValues(
                        alpha: 0.3,
                      ),
                    ),
                  Flexible(
